...
const compairtwoTrees=require('../lb/compare');
...
describe('comparing between two directory', ()=>{
  it('both have same number of files', ()=> {
    expect(compairtwoTrees(firstTree,secondTree)).toEqual(`Both trees contain 5 files.`);
  });
  it('they dont have same number of files', ()=> {
    expect(compairtwoTrees(firstTree,thierdTree)).toEqual(`The first tree has 5 files, while the second has 3.`);
  });
